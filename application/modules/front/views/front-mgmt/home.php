                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 align-center">
                                ...
                                <!-- <div class="slider-content">
                                    ...
                                    <p class="slider-content-text" data-swiper-parallax="-200">Netforceis your reliable partner and a sure hub for all important need of everyone. In Netforcewe give the platform to transact and also get quick help whenever and however you need it.</p>
            ...
            <div class="slider-slides main-slider-slides">
                ...
                <div class="main-slider-slides-wrap">
                    ...
                    <div class="slides-item bg-red-themes">
                        ...
                        <div class="h5 slides-item-title">NetforceOrganics</div>
                    ...
                    <div class="slides-item bg-yellow-themes">
                        ...
                        <div class="h5 slides-item-title">NetforceCommunity</div>
    ...
    <section class="large-padding section-anime-js">
        ...
        <div class="container">
            ...
            <p class="text-center">
							...
							<b>Netfoce</b>  is your reliable partner and a sure hub for all important need of everyone. In Netforcewe give you the platform to transact and also get quick help whenever and however you need it.
    </p>

  <p class="text-center"><a href="https://netforce.mlmstore.co//about-us" class="crumina-button button--dark button--bordered button--l">LEARN MORE</a></p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-4 element-anime-fadeInUp-js">
                    ...
                    <div class="crumina-module br-top active">
                        ...
                        <div class="info-box-content">
                                ...
                                <h5 class="info-box-title font-weight-normal">NetforceOrganics</h5>
...
</p>											<p class="text-center"><a href="https://netforce.mlmstore.co//organic-products" class="crumina-button button--dark button--bordered button--l">LEARN MORE</a></p>
                    ...
                    <div class="crumina-module br-top">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="info-box-text text-justify">This platform will financially empower members to transact and earn a commission up to 20% by referring someone to buy or sell properties displayed in this website.</p>
														<p class="text-center"><a href="https://netforce.mlmstore.co//property" class="crumina-button button--dark button--bordered button--l">LEARN MORE</a></p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-4 element-anime-fadeInUp-js">
                    ...
                    <div class="crumina-module br-top">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-title font-weight-normal">NetforceGas & Steam Turbine</h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-4 mb-md-0 element-anime-fadeInUp-js">
                    ...
                    <div class="crumina-module br-top">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-title font-weight-normal">NetforceE-Shopping</h5>

                            <p class="info-box-text text-justify">Netforceonline mart is where you can get every of your necessities just by a click and get the goods delivered to you on time.
</p>

<p class="text-center"><a href="https://netforce.mlmstore.co//ecommerce" class="crumina-button button--dark button--bordered button--l">LEARN MORE</a></p>
...
<p class="text-center"><a href="https://netforce.mlmstore.co//project-development" class="crumina-button button--dark button--bordered button--l">LEARN MORE</a></p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-4 element-anime-fadeInUp-js">
                    ...
                    <div class="crumina-module br-top">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-title font-weight-normal">NetforceLogistics
</h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-4 mb-lg-0 element-anime-fadeInUp-js">
                    ...
                    <div class="crumina-module crumina-case-item">
                        ...
                        <div class="case-item-content">
                            ...
                            <a href="12_project_details_ver_01.html" class="h6 case-item-title">NetforceTea</a>
