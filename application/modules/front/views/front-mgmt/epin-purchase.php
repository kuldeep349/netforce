                                ...
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                        <div class=" ">
                                            ...
                                            <h2 class="font-weight-7 margin-bottom-2">E-Pin Purchase </h2>
                                            ...
                                            <table> 
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach($packages as $k => $package){
                                                        ...
                                                        echo'<td>$'.$package->amount.'<input type="hidden" name="package_id[]" value="'.$package->id.'"></td>';
                                                        echo'<td><input type="number" name="quantity[]" class="form-control pinCount" data-amount="'.$package->amount.'" data-id="'.$package->id.'"></td>';
                                                        echo'<td><span id="pinAmount'.$package->id.'" class="pinAmount">0</span></td>';
                                                        echo'</tr>';
                                                    }
                                                    ?>
                                                        <tr>
