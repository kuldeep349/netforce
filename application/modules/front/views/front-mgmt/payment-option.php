   ...
   <div class="card card-hero animated slideInUp animation-delay-8 mb-6">
      <div class="card-body">
               ...
               //   echo'</pre>';
				  ...
				  {   
                   /*$amount= round(($registration_info['sponsor_and_account_info']['pkg_amount'] )* 5000* $usd_price);
                 if($registration_info['sponsor_and_account_info']['pkg_amount'] == 10){
                    $amount = '510000';   
                 }elseif($registration_info['sponsor_and_account_info']['pkg_amount'] == 19){
                  $amount = '950000';   
                 }elseif($registration_info['sponsor_and_account_info']['pkg_amount'] == 36){
                  $amount = '1800000';   
                 }elseif($registration_info['sponsor_and_account_info']['pkg_amount'] == 70){
                  $amount = '3500000';   
                 }*/
              $amount = $registration_info['sponsor_and_account_info']['pkg_amount']*TEST_PUBLIC_RATE*100;  
				  ?>       
				  <div class="col-md-4">				
