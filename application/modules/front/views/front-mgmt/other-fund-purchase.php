                                ...
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                        <div class=" ">
                                            ...
                                            <h2 class="font-weight-7 margin-bottom-2">Other Purchase </h2>
                                            ...
                                            <table> 
                                                <thead>
                                                    <tr>
                                                        <td  colspan="2" class="text-center">Purpose</td>
                                                        <td  colspan="3">
                                                            <select class="form-control" name="purpose">
                                                                ...
                                                                <option>Stockist Fee</option>
                                                                <option>Digital Money</option>
