                ...
                <!-- Slides -->
                    <div class="container">
                        <div class="row align-items-center">
                            <p>We have a Team of highly skilled Engineers who are experts in the building and maintenance 
								of gas and steam turbine of any capacity.
								We deliver a high performance gas and steam turbine of any capacity anywhere anytime<br>
								<b>Nature:</b>
								<br>
								The Equipment's are steam turbines, high speed centrifugal pumps.
								Overhauls, repairs, reconditioning and lots more. <br>
								We create opportunity for our Members to earn good commissions, when they bring in clients who patronize our services in this platform.
							</p>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 align-center">
                                <div class="slider-thumb" data-swiper-parallax="-400" data-swiper-parallax-duration="600">
                                    <img loading="lazy"  src="<?php echo base_url();?>images/turbine/turbine<?php echo $i; ?>.jpeg" width="980" alt="SEO">
                                </div>
