...
<div class="main-content-wrapper">
	...
	<section class="crumina-stunning-header section-image-bg-purple">
		<div class="container">
			...
			<div class="stunning-header-content align-center">
				<!-- PAGE TITLE -->
				<h1 class="page-title text-white">Digital Money</h1>
				<!-- /PAGE TITLE -->
				<!-- BREADCRUMBS -->
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p>To transact in this platform, the buyer/seller is to fill in the form provided with valid information of self and follow the process provided. Any information you provide in this platform is not exposed to a third party, so feel free to transact.</p>
            <ul>
                The services we transact here include;
                <li>Send digital Money to a business or institution account </li>
                <li>	Send digital Money to Individual or Agents account</li>
                <li>	Send and receive Money all over the world from our platform</li>
                <li>	Give you opportunity to become our Digital Money agent</li>
                <li>	Give our members good commission of 0.020$-0.025$ per 1USD of the amount of transaction they refer to the system. This earning is either for buying/selling or sending/receiving digital money.</li>
                <li>	We give you opportunity to invest in our Digital Money deals and earn good interest from it every month.</li>
            </ul>
        </div>
    </div>
        	</div>
