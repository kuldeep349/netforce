	...
	<section class="crumina-stunning-header section-image-bg-purple">
		<div class="container">
			...
			<div class="stunning-header-content align-center">
				<!-- PAGE TITLE -->
				<h1 class="page-title text-white">Netforce Network Marketing Gold</h1>
				<!-- /PAGE TITLE -->
				<!-- BREADCRUMBS -->
				<div class="crumina-breadcrumbs">
					...
					<ul class="breadcrumbs">
						...
						<li class="breadcrumbs-item trail-end">
							...
							<span>Netforce Network Marketing Gold</span>
						</li>
						<!-- /BREADCRUMBS ITEM -->
					</ul>
					<!-- /BREADCRUMBS LIST -->
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 align-center">
                                <div class="slider-thumb" data-swiper-parallax="-400" data-swiper-parallax-duration="600">
                                    <img loading="lazy"  src="<?php echo base_url();?>front_assets/img/gold/Gold <?php echo $i; ?>.png" width="980" alt="SEO">
                                </div>
