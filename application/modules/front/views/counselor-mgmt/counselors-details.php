	...
	<section class="crumina-stunning-header section-image-bg-dark">
		<div class="container">
			...
			<div class="stunning-header-content align-center">
				<!-- PAGE TITLE -->
				<h1 class="page-title text-white">Counselor Details</h1>
				<!-- /PAGE TITLE -->
				<!-- BREADCRUMBS -->
				<div class="crumina-breadcrumbs">
					...
					<ul class="breadcrumbs">
						...
						<li class="breadcrumbs-item">
							...
							<a href="<?php echo base_url();?>doctor-list">Counselor</a>
						</li>
						<!-- /BREADCRUMBS ITEM -->
						<!-- BREADCRUMBS ITEM -->
						<li class="breadcrumbs-item trail-end">
							<span class="crumina-icon">»</span>
							<span>Counselor Details</span>
						</li>
						<!-- /BREADCRUMBS ITEM -->
					</ul>
					<!-- /BREADCRUMBS LIST -->
			...
			<div class="row">
								...
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="product-details-gallery-item">
											<?php if(isset($counselors_detail['counselors_image']) && !empty($counselors_detail['counselors_image'])){ ?>
											<img loading="lazy" class="crumina-icon"  src="<?php echo base_url();?>doctor_images/<?php echo $counselors_detail['counselors_image']; ?>" alt="product">
										<?php }else{ ?>
				...
				<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
					<div class="product-details-content">
						<h2 class="product-title"><?php echo $counselors_detail['counselors_name']; ?></h2>
						<div class="price-review-wrap">
							<div class="price">
								<ins>
								<span class="woocommerce-Price-amount amount">
									<span class="woocommerce-Price-currencySymbol">$</span>
									<?php echo $counselors_detail['counselors_fee']; ?>
								</span>
								</ins>
							</div>
							<ul class="rait-stars">
						...
						<?php echo $counselors_detail['counselors_bio']; ?>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                          <?php echo $counselors_detail['counselors_timing']; ?>
