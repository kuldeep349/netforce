...
<div class="main-content-wrapper">
	<!-- STUNNING HEADER -->
	<section class="crumina-stunning-header section-image-bg-purple" style="background: url(<?php echo base_url();?>images/Online-Counselor.jpeg);     background-size: cover;
		background-position: center;">
		<div class="container">
			<!-- STUNNING HEADER CONTENT -->
			<div class="stunning-header-content align-center">
				<!-- PAGE TITLE -->
				<h1 class="page-title text-white">Counselor</h1>
				<!-- /PAGE TITLE -->
				<!-- BREADCRUMBS -->
	...
	<section class="large-padding section-anime-js">
        <div class="container">
        	<?php if(isset($counselors_list) && count($counselors_list)>0){
                      foreach ($counselors_list as $key => $value) {
                if($inc%3==1)
                      {
				?>
               <div class="row justify-content-center" style="margin: 0 0 20px 0;">
            <?php } ?>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-4 mb-lg-0 element-anime-fadeInUp-js">
                    <div class="crumina-module crumina-case-item">
                    	<?php if(isset($value['counselors_image'])){ ?>
							<a href="#" class="case-item-thumb">
								<img loading="lazy" src="<?php echo base_url();?>doctor_images/<?php echo $value['counselors_image']; ?>" alt="product">
							</a>
						<?php }else { ?>
							<a href="#" class="case-item-thumb">
								<img loading="lazy" src="<?php echo base_url();?>front_assets/img/demo-content/avatars/no-avatar.png" alt="product">
							</a>
						<?php } ?>


                        <div class="case-item-content">
                        	<a href="<?php echo base_url();?>counselors-details/<?php echo ID_encode($value['counselors_id']);?>" class="h6 case-item-title"><?php echo $value['counselors_name']; ?></a>

                        	<div class="case-item-cat">
                               <?php echo $value['counselors_fee']; ?>
                                <a href="<?php echo base_url();?>counselors-details/<?php echo ID_encode($value['counselors_id']);?>" class="crumina-button button--primary button--m w-100">Consult now</a>
        ...
        <?php }else if($inc==count($counselors_list)){ ?>
        	</div>
        <?php } ?>
        <?php $inc++; }} ?>
