			...
			<div class="row">
				...
				<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
					<div class="product-details-content">
						<h2 class="product-title"><?php echo $doctor_list['doctor_name']; ?></h2>
						<div class="price-review-wrap">
							<div class="price">
								<ins>
								<span class="woocommerce-Price-amount amount">
									<span class="woocommerce-Price-currencySymbol">$</span>
									<?php echo $doctor_list['doctor_fee']; ?>
								</span>
								</ins>
							</div>
							<ul class="rait-stars">
						...
						<?php echo $doctor_list['doctor_bio']; ?>

						<div class="quantity-btn-wrap">
							<!-- CRUMINA BUTTON -->
							<a href="#" class="crumina-button button--primary button--with-icon button--icon-right button--m" data-toggle="modal" data-target="#BookAppointment">Book Appointment</a>
							<!-- /CRUMINA BUTTON -->
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                          <?php echo $doctor_list['doctor_timing']; ?>
