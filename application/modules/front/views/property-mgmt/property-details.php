				...
				<div class="crumina-breadcrumbs">
					...
					<ul class="breadcrumbs">
						...
						<li class="breadcrumbs-item">
							...
							<a href="<?php echo base_url();?>doctor-list">Property</a>
						</li>
						<!-- /BREADCRUMBS ITEM -->
						<!-- BREADCRUMBS ITEM -->
			...
			<div class="row">
					...
					<div class="product-details-thumb">
						<div class="crumina-module crumina-module-slider products-gallery-slider">
							<div class="swiper-container" data-show-items="1" data-change-handler="thumbsParent" data-prev-next="1">
								<?php
                                ////print_r(unserialize($property_detail['sub_images']));
								if(count(unserialize($property_detail['sub_images']))>0){ ?>
                                  <div class="swiper-wrapper">
                                  	<?php foreach (unserialize($property_detail['sub_images']) as $key => $proGal) { ?>
                                  
									<div class="swiper-slide">
										<div class="product-details-gallery-item">
											<img loading="lazy" class="crumina-icon"  src="<?php echo base_url();?>property_images/<?php echo $proGal['sub_img']; ?>" alt="product">
										</div>
									</div>
								<?php } ?>
								</div>
								<div class="slider-slides">
									<?php foreach (unserialize($property_detail['sub_images']) as $key => $thumbGal) {
                                        if($key==0)
                                        {
                                          $activeGal='swiper-slide-active';
                                        }else
                                        {
                                          $activeGal='';
                                        }
									 ?>
									<a href="#" class="slides-item <?php echo $activeGal; ?>">
										<img loading="lazy" class="crumina-icon"  src="<?php echo base_url();?>property_images/<?php echo $thumbGal['sub_img']; ?>" alt="product">
									</a>
									<?php } ?>
								</div>
								...
								<?php } else { ?>
								  <div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="product-details-gallery-item">
											<?php if(isset($property_detail['property_image']) && !empty($property_detail['property_image'])){ ?>
											<img loading="lazy" class="crumina-icon"  src="<?php echo base_url();?>property_images/<?php echo $property_detail['property_image']; ?>" alt="product">
										<?php }else{ ?>
				...
				<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
					<div class="product-details-content">
						<h2 class="product-title"><?php echo $property_detail['property_name']; ?></h2>
						<div class="price-review-wrap">
							<div class="price">
								<ins>
								<span class="woocommerce-Price-amount amount">
									<span class="woocommerce-Price-currencySymbol">$</span>
									<?php echo $property_detail['budget']; ?>
								</span>
								</ins>
							</div>
							<ul class="rait-stars">
						...
						<?php echo $property_detail['short_description']; ?>

						<div class="quantity-btn-wrap">
							<!-- CRUMINA BUTTON -->
							<!----a href="#" class="crumina-button button--primary button--with-icon button--icon-right button--m">Book Appointment</a---->
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                          <?php echo $property_detail['long_description']; ?>
