	...
	<section class="crumina-stunning-header section-image-bg-purple">
		<div class="container">
			...
			<div class="stunning-header-content align-center">
				<!-- PAGE TITLE -->
				<h1 class="page-title text-white">Property</h1>
				<!-- /PAGE TITLE -->
				<!-- BREADCRUMBS -->
...
<section class="large-padding section-anime-js">
        <div class="container">
        	<?php $inc=1; if(isset($property_list) && count($property_list)>0){
            ...
            <?php } ?>
            	<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-4 mb-lg-0 element-anime-fadeInUp-js">
                    <div class="crumina-module crumina-case-item">
                    	<?php if(isset($value['property_image'])){ ?>
							<a href="#" class="case-item-thumb">
								<img loading="lazy" src="<?php echo base_url();?>property_images/<?php echo $value['property_image']; ?>" alt="product">
							</a>
						<?php }else { ?>
							<a href="#" class="case-item-thumb">
                        ...
                        <div class="case-item-content">
                        	<a href="<?php echo base_url();?>property-details/<?php echo ID_encode($value['prop_id']);?>" class="h6 case-item-title"><?php echo $value['property_name']; ?></a>
                        	
                        	<div class="case-item-cat">
                               <?php echo $value['budget']; ?>
                                <a href="<?php echo base_url();?>property-details/<?php echo ID_encode($value['prop_id']);?>" class="crumina-button button--primary button--m w-100">View Detail</a>
        ...
        <?php }else if($inc==count($property_list)){ ?>
        	</div>
        <?php } ?>	
        <?php $inc++; }} ?>
