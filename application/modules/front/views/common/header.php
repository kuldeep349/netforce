...
<head>
    ...
    <!-- bootstrap 4.3.1 -->
    <link rel="stylesheet" href="<?php echo base_url();?>front_assets/css/vendors/Bootstrap/bootstrap.min.css">
    <!-- site header styles -->
    <link href="<?php echo base_url();?>front_assets/css/plugins/navigation.min.css" rel="stylesheet">
    <!-- main styles -->
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url();?>front_assets/img/theme-content/favicon/favicon-16x16.png">
    <link rel="manifest" href="<?php echo base_url();?>front_assets/img/theme-content/favicon/site.webmanifest">
...
s1.async=true;
s1.src='https://embed.tawk.to/5fed8079df060f156a9293b3/1eqrrrn16';
s1.charset='UTF-8';
