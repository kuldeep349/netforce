...
<footer id="site-footer" class="footer dark-section">
    <div class="container-fluid custom">
        <marquee direction = "left" id="id01">
            <span><?php echo $mar[1]['text'];?></span>
        </marquee>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-7 col-md-6 col-sm-12 mb-md-0">
                    ...
                    <div class="widget w-info widget--footer mb-4">
                        <h4 class="widget-title">TopTen Company!</h4>
                        ...
                        <div class="socials">
                            ...
                            <a class="social-item" href="#">
                                ...
                                <img loading="lazy" width="32" height="32" class="crumina-icon"  src="<?php echo base_url();?>front_assets/img/theme-content/social-icons/facebook.svg" alt="facebook">

                            </a>

                            <a class="social-item" href="#">

                                <img loading="lazy" width="32" height="32" class="crumina-icon"  src="<?php echo base_url();?>front_assets/img/theme-content/social-icons/twitter.svg" alt="twitter">

                            </a>

                            <a class="social-item" href="#">

                                <img loading="lazy" width="32" height="32" class="crumina-icon"  src="<?php echo base_url();?>front_assets/img/theme-content/social-icons/google.svg" alt="google">

                            </a>

                            <a class="social-item" href="#">

                                <img loading="lazy" width="32" height="32" class="crumina-icon"  src="<?php echo base_url();?>front_assets/img/theme-content/social-icons/youtube.svg" alt="youtube">

                            </a>

                            <a class="social-item" href="#">

                                <img loading="lazy" width="32" height="32" class="crumina-icon"  src="<?php echo base_url();?>front_assets/img/theme-content/social-icons/rss.svg" alt="rss">
        ...
        <div class="contacts">
            ...
            <div class="contacts-item">
                ...
                <div class="content">
                    ...
                    <div class="title c-white">India</div>

                    <p class="sub-title">Nigeria</p>
            ...
            <div class="contacts-item">
                ...
                <div class="content">
                  ...
                  <div class="widget widget_links widget--footer">
                      ...
                      <h4 class="widget-title">Site Link</h4>
                      ...
                      <ul>
                          ...
                          <li>
                              ...
                              <a href="<?php echo site_url();?>terms_and_condition">
