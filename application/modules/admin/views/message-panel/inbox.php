                        ...
                        <td>
	                     ...
	                     <td>
	                        <ul class="icons-list">
	                           ...
	                           <li>
	                              <a onclick="return deleteConfirm();" href="<?php echo site_url();?>admin/MessagePanel/deleteInboxMessage/<?php echo ID_encode($msg->id);?>" data-popup="tooltip" title="" data-original-title="Close Ticket"><i class="icon-trash"></i></a>
	                           </li>
	                        </ul>
	                     </td>
	                  </tr>
