...
<div class="content-wrapper">
   ...
   <div class="content">
      ...
      if(!empty($this->session->flashdata('flash_msg1')))
      {
      ?>
      <div class="alert alert-danger alert-styled-right alert-arrow-right alert-bordered">
         <button type="button" class="close" data-dismiss="alert"><span>×</span><span class="sr-only">Close</span></button>
         <?php echo $this->session->flashdata('flash_msg1');?>
      </div>
      <?php    
      }
      ?>
         ...
         <div class="panel-body">
            <div class="row">
                 <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                       <form action="<?php echo site_url();?>admin/member/updateUserName/<?php echo ID_encode($user_id);?>" method='post' enctype='multipart/form-data'>
                          <div class="form-group">
                             <div class="row">
                                <div class="col-md-6">
                                   <!--<label>User Name</label>-->
                                   <input type="text" name='user_name' value="<?php echo $user_details->username;?>" class="form-control">
                                   <input type="hidden" name='hidden_user_name' value="<?php echo $user_details->username;?>" class="form-control">
                                </div>
                                <div class="col-md-6">
