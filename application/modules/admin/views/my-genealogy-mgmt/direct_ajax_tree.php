                                              ...
                                              ?>
                                                   ...
                                                   <div data-gid="3" onmouseover="trigger_hover(this)"  class="binary-node-single-item user-block " id="user_block_<?php echo $root->user_id;?>">
                                                      <div class="images_wrapper">
                                                         <a href="/afl/genealogy-tree/1"><img class="profile-rounded-image-small" src="<?php echo base_url();?>images/<?php echo $root_member_image;?>" width="70" height="70" alt="business.admin" title="business.admin" /></a>
                                                      </div>
