                     ...
                     <table class="table datatable-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="icons-list">
                                    <li>
                                        <a href="<?php echo base_url('admin/SupportTicket/viewTicket/'.(isset($ticket) && !empty($ticket) && is_object($ticket) ? base64_encode($ticket->ticket_no) : 'N/A')) ?>" data-popup="tooltip" title="" data-original-title="View Response"><i class="icon-pencil7"></i></a>
                                    </li>
                                </ul>
                            </td>
                        </tr>
