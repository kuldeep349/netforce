   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Marketing Tools</span> - Add Marketing Image</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">Add Marketing Image</li>
         </ul>
      </div>
   </div>
   <!-- /page header -->
         ...
         <div class="col-md-12">
            ...
            <div class="panel panel-flat">
               <div class="panel-heading">
                  <h5 class="panel-title">Add Marketing Image</h5>
               ...
               <?php 
                  echo form_open(site_url()."admin/MarketingTools/addMarketingImage",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
                  ?>
               <div class="panel-body">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-9">
                        <input name='image_path' id='image_path' type="file" class="file-input">
                     </div>
                  </div>
