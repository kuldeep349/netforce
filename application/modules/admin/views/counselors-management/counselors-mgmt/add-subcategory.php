						...
						<div class="col-md-12">
							<!-- Basic layout-->
								<div class="panel panel-flat">
									...
									<a class="heading-elements-toggle"><i class="icon-menu"></i></a></div>
										<?php 
 echo form_open(site_url().$module_name."/Counselors_Management/addNewCounselorsSubCategory",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
										?>
