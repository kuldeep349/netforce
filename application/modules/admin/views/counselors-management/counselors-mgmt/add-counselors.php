   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Counselors Management</span> - Add New Counselors</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="#">Counselors Management</li>
            <li class="active">Add New Counselors</li>
         </ul>
      </div>
   </div>
   <!-- /page header -->
         ...
         <div class="col-md-12">
            ...
            <div class="panel panel-flat">
               <div class="panel-heading">
                  <h5 class="panel-title">Add New Counselors</h5>
               ...
               <?php 
                  echo form_open(site_url().$module_name."/Counselors_Management/addNewCounselors",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
                  									?>
               <div class="panel-body">
                <div class="form-group">
                     <label class="col-lg-3 control-label">Select Counselors Main Category <span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                  ...
                  <div class="form-group">
                     <label class="col-lg-3 control-label">Counselors Name <span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                        <input type="text" name="counselors_name" class="form-control" placeholder="Counselors Name">
                     </div>
                  </div>
                   <div class="form-group">
                     <label class="col-lg-3 control-label">Counselors Specialty <span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                        <input type="text" name="counselors_specialty" class="form-control" placeholder="Counselors Specialty">
                     </div>
                  </div>
                  <div class="form-group">
                     <label class="col-lg-3 control-label">Counselors Image<span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                        <input name='counselors_image' type="file" class="file-input">
                     </div>
                  ...
                  <div class="form-group">
                     <label class="col-lg-3 control-label">Counselors Fee:</label>
                     <div class="col-lg-9">
                        <input type="text"  name="counselors_fee" class="form-control" placeholder="Counselors Fee">
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-9">
                        <textarea id="description" name="time_description" class="col-lg-3 control-label"></textarea>
                     </div>
                  </div>
				  <div class="form-group">
...
$(document).ready(function(){
   ...
   $("#parent_category_id").change(function(){
	  ...
	  jQuery.ajax({
                  type:'POST',
                  url:'<?php echo site_url();?>admin/Counselors_Management/getAjaxSubCategory',
