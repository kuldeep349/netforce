   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         ...
         <div class="heading-elements">
            ...
            <a href="<?php echo site_url().$module_name;?>/Counselors_Management/addNewCounselorsSubCategory" class="btn btn-success"><i class="icon-comment-discussion position-left"></i> Add New Sub Category</a>
            </div>
                     </div>
         </div>
      </div>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <ul class="icons-list">
                           <li>
                              <a href="<?php echo site_url().$module_name;?>/Doctor_Management/editSubCategory/<?php echo ID_encode($cat['sub_cat_id']);?>" data-popup="tooltip" title="" data-original-title="Edit Category"><i class="icon-pencil7"></i></a>
                           </li>
						   <li>
                       <a onclick='return confirm("Are you sure?");' href="<?php echo site_url().$module_name;?>/Doctor_Management/deleteSubCategory/<?php echo ID_encode($cat['sub_cat_id']);?>" data-popup="tooltip" title="" data-original-title="Delete Category"><i class="icon-trash"></i></a>
                     </li>
