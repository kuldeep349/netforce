               ...
               <form action="<?php echo site_url();?>admin/UserWallet/addFundToUserWallet" method="post">
                  <div class="">
                      <div class="form-group">
                        <select name="wallet_type" id="wallet_type" class="select-menu-color">
                            <option value='e'>Main</option>
                            <option value='cash'>Cash</option>
                            <option value='product'>Product</option>
                            <option value='car'>car</option>
                            <option value='bonus'>Bonus</option>
                            <option value='saving'>Shopping</option>
                     ...
                     <div class="form-group">
                        <input type="number" min="0" step="any" value="0" name="amount" id="amount" class="form-control" placeholder="Enter Amount">
         ...
         <div class="panel-body">
            <div class="row">
               <form action="<?php echo site_url();?>admin/UserWallet/deductFundFromUserWallet" method="post">
                  <div class="">
                      <div class="form-group">
                        <select name="wallet_type" id="d_wallet_type" class="select-menu-color">
                            <option value='e'>Main</option>
                            <option value='cash'>Cash</option>
                            <option value='product'>Product</option>
                            <option value='car'>car</option>
                     ...
                     <div class="form-group">
                        <input type="number" min="0"  step="any" value="0" name="amount" id="d_amount" class="form-control" placeholder="Enter Amount">
...
<script>
   ...
   $(document).ready(function(){
         $("#username").change(function(){
            ...
            $.ajax({
                  url: "<?php echo site_url();?>admin/UserWallet/getUserEwalletBalanceType/"+username+'/'+wallet_type,
                  method: "GET",
         ...
         $("#amount").bind('keyup change blur',function(){
            ...
            var admin_wallet_amount=parseFloat($("#current_admin_wallet_amount").val());
            if(username=="<?php echo COMP_USERNAME;?>" || username=="<?php echo COMP_USER_ID;?>" )
            {
              if(!isNaN(amount) && amount!='')
              {
               admin_wallet_amount=parseFloat(amount)+admin_wallet_amount;
            ...
            else 
            {
              if(!isNaN(amount) && amount!='')
              {
               admin_wallet_amount=admin_wallet_amount-parseFloat(amount);
   ...
   $(document).ready(function(){
         $("#d_username").change(function(){
            var username=$(this).val();
            var wallet_type=$('#d_wallet_type').val();
            $.ajax({
                  url: "<?php echo site_url();?>admin/UserWallet/getUserEwalletBalanceType/"+username+'/'+wallet_type,
                  method: "GET",
                  success:function(res){
         ...
         $("#d_amount").bind('keyup change blur',function(){
            ...
            var admin_wallet_amount=parseFloat($("#d_current_admin_wallet_amount").val());
            var user_wallet_amount=parseFloat($("#d_current_user_wallet_amount").val());
            ...
            if(!isNaN(amount) && amount!='')
             ...
             if(!isNaN(amount) && amount!='')
             {
               user_wallet_amount=user_wallet_amount-parseFloat(amount);
