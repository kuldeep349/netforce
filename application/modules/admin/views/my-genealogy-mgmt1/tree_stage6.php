                                          ...
                                          <li>
                                             <a
                                                <?php if(!empty($level2_user_id5))
                                                   {
                                                   ?>
                                                href="<?php echo site_url();?>admin/MyGenealogy1/stage6Tree/<?php echo ID_encode($level2_user_id5);?>"
                                                <?php    
                                                   }
                                                   else
                                                   {
										  ...
										  <li>
                                             <a
                                                <?php if(!empty($level2_user_id6))
                                                   {
                                                   ?>
                                                href="<?php echo site_url();?>admin/MyGenealogy1/stage6Tree/<?php echo ID_encode($level2_user_id6);?>"
                                                <?php    
                                                   }
                                                   else
                                                   {
									...
									<li>
                                       <a
                                          <?php if(!empty($level1_user_id3))
                                             {
                                             ?>
                                          href="<?php echo site_url();?>admin/MyGenealogy1/stage6Tree/<?php echo ID_encode($level1_user_id3);?>"
                                          <?php    
                                             }
                                             else
                                             {
                                          ...
                                          <li>
                                             <a
                                                <?php if(!empty($level2_user_id7))
                                                   {
                                                   ?>
                                                href="<?php echo site_url();?>admin/MyGenealogy1/stage6Tree/<?php echo ID_encode($level2_user_id7);?>"
                                                <?php    
                                                   }
                                                   else
                                                   {
                                          ...
                                          <li>
                                             <a
                                                <?php if(!empty($level2_user_id8))
                                                   {
                                                   ?>
                                                href="<?php echo site_url();?>admin/MyGenealogy1/stage6Tree/<?php echo ID_encode($level2_user_id8);?>"
                                                <?php    
                                                   }
                                                   else
                                                   {
										  ...
										  <li>
                                             <a
                                                <?php if(!empty($level2_user_id9))
                                                   {
                                                   ?>
                                                href="<?php echo site_url();?>admin/MyGenealogy1/stage6Tree/<?php echo ID_encode($level2_user_id9);?>"
                                                <?php    
                                                   }
                                                   else
                                                   {
