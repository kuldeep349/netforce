   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">User Shopping E-Wallet</span> - User Shopping Wallet Balance</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li><a href="#">User Shopping E-Wallet</a></li>
            <li class="active">User Shopping Wallet Balance</li>
         </ul>
      ...
      <div class="row">
         <div class="panel panel-flat">
            <div class="panel-heading">
               <h5 class="panel-title">User Shopping Wallet Balance</h5>
               <div class="heading-elements">
                  <ul class="icons-list">
