   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">E-Pin Management</span> - Cancelled E-Pin Request</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">Cancelled E-Pin Request</li>
         </ul>
         ...
         <div class="panel panel-flat">
            ...
            <table class="table datatable-responsive">
               ...
               <tbody>
                  <?php 
                     $total_pin_amount=0;
                     if(!empty($cancelled_epin_request) && count($cancelled_epin_request)>0)
                     {
                        $sno=0;
                        foreach ($cancelled_epin_request as $request) 
                        {
                           $sno++;
                  ...
                  <tr>
                     ...
                     <td><?php echo $request->response_date;?></td>
                     ...
                     <td><span class="label label-danger">Cancelled Request</span></td>
                  </tr>
                  <?php    
                     }
                     }
