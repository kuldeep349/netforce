            ...
            <table class="table datatable-responsive">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><?php echo $epin->blocked_date;?></td>
                        ...
                        <ul class="icons-list">
                           ...
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-right">
                                 ...
                                 <li><a href="<?php echo site_url();?>admin/epin/deleteEpin/<?php echo ID_encode($epin->id);?>"><i class="icon-thumbs-up2"></i>Delete Pin</a></li>

                                 <li><a href="<?php echo site_url();?>admin/epin/unBlockEpin/<?php echo ID_encode($epin->id);?>"><i class="icon-file-excel"></i> Unblock E-Pin</a></li>
