   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Organic</span> - Orders</h4>
         </div>
            ...
            <table class="table datatable-responsive table-bordered table-striped table-hover" >
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><?php echo $order['userinfo']['email'];?></td>
                     <td><?php echo $order['userinfo']['contact_no'];?></td>
                     <td><?php echo $order['stockist']['category_name'];?></td>
                     <td><?php echo ($order['payment_method'] == 1) ? 'Cash Payment' : ($order['payment_method'] == 2) ? 'Ewallet' : 'Pay fast payment' ;?></td>
   ...
   $(document).ready(function(){
	...
	$(".change_status").change(function(){
		...
		if(window.confirm('Are you Sure? you want to change the product status.'))
		{
			...
			var url='pendingB_Orders';
			window.location.href='<?php echo site_url();?>admin/eshop_orders/change_status_b_new/'+order_id+"/"+order_status+"/"+url;
		}
		else 
		{
			return false;
