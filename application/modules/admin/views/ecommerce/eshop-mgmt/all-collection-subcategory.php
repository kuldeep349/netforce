   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         ...
         <div class="heading-elements">
            ...
            <a href="<?php echo site_url().$module_name;?>/eshop/addNewcollectionSubCategory" class="btn btn-success"><i class="icon-comment-discussion position-left"></i> Add New Sub Category</a>
            </div>
                     </div>
         </div>
      </div>
                  ...
                  <tr>
					 ...
					 <td>
						  ...
						  if($index>0)
						  {
							  ...
							  //pr($previous_subject);
						  ?>
						  <a href="<?php echo site_url().$module_name."/".$controller_name;?>/moveUp/eshop_collection_subcategory/<?php echo $cat['position'];?>/<?php echo $previous_subject['position'];?>">Move Up</a>
						  <?php 
						  }
						  else 
						  {
                     ...
                     <td>
                        <ul class="icons-list">
                           <li>
                              <a href="<?php echo site_url().$module_name;?>/eshop/editcollectionSubCategory/<?php echo ID_encode($cat['id']);?>" data-popup="tooltip" title="" data-original-title="Edit Category"><i class="icon-pencil7"></i></a>
                           </li>
