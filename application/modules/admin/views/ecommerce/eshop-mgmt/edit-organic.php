      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="panel panel-flat">
               ...
               <?php 
                  echo form_open(site_url().$module_name."/eshop/editOrganicProduct",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
                  									?>
               <div class="panel-body">
				...
				<?php 
                  ...
                  <div class="form-group">
                     <label class="col-lg-3 control-label">Member Price<span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
