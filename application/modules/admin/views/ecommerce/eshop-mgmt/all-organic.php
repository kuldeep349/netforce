   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         ...
         <div class="heading-elements">
            ...
            <a href="<?php echo site_url().$module_name;?>/eshop/addNewOrganicProduct" class="btn btn-success"><i class="icon-comment-discussion position-left"></i> Add New Product</a>
            </div>
                     </div>
         </div>
      </div>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <ul class="icons-list">
                           <li>
                              <a href="<?php echo site_url().$module_name;?>/eshop/editOrganicProduct/<?php echo ID_encode($prod['id']);?>" data-popup="tooltip" title="" data-original-title="Edit Product"><i class="icon-pencil7"></i></a>
                           </li>
						   <!--
						   <li>
