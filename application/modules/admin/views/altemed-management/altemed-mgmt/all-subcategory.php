   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Doctor</span> - Sub Category</h4>
         </div>
         <div class="heading-elements">
            <div class="heading-elements">
            <div class="heading-btn-group">
            <a href="<?php echo site_url().$module_name;?>/Alternative_medicine/addNewAltmedSubCategory" class="btn btn-success"><i class="icon-comment-discussion position-left"></i> Add New Sub Category</a>
            </div>
                     </div>
         </div>
      </div>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <ul class="icons-list">
                           <li>
                              <a href="<?php echo site_url().$module_name;?>/Alternative_medicine/editSubCategory/<?php echo ID_encode($cat['sub_cat_id']);?>" data-popup="tooltip" title="" data-original-title="Edit Category"><i class="icon-pencil7"></i></a>
                           </li>
						   <li>
                       <a onclick='return confirm("Are you sure?");' href="<?php echo site_url().$module_name;?>/Alternative_medicine/deleteSubCategory/<?php echo ID_encode($cat['sub_cat_id']);?>" data-popup="tooltip" title="" data-original-title="Delete Category"><i class="icon-trash"></i></a>
                     </li>
