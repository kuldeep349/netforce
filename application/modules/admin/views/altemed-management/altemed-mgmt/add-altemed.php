   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Alternative Medicine</span> - Add New Alternative Medicine</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="#">Alternative Medicine Management</li>
            <li class="active">Add New Alternative Medicine</li>
         </ul>
      </div>
   </div>
   <!-- /page header -->
         ...
         <div class="col-md-12">
            ...
            <div class="panel panel-flat">
               <div class="panel-heading">
                  <h5 class="panel-title">Add New Alternative Medicine</h5>
               ...
               <?php 
                  echo form_open(site_url().$module_name."/Alternative_medicine/addNewAltmed",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
                  									?>
               <div class="panel-body">
                <div class="form-group">
                     <label class="col-lg-3 control-label">Select Alternative Medicine Main Category <span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                  ...
                  <div class="form-group">
                     <label class="col-lg-3 control-label">Alternative Medicine Name <span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                        <input type="text" name="altmed_name" class="form-control" placeholder="Alternative Medicine Name">
                     </div>
                  </div>
                   <div class="form-group">
                     <label class="col-lg-3 control-label">Alternative Medicine Specialty <span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                        <input type="text" name="altmed_specialty" class="form-control" placeholder="Alternative Medicine Specialty">
                     </div>
                  </div>
                  <div class="form-group">
                     <label class="col-lg-3 control-label">Alternative Medicine Image<span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                        <input name='altmed_image' type="file" class="file-input">
                     </div>
                  ...
                  <div class="form-group">
                     <label class="col-lg-3 control-label">Alternative Medicine Price:</label>
                     <div class="col-lg-9">
                        <input type="text"  name="altmed_price" class="form-control" placeholder="Alternative Medicine Price">
                     </div>
                  </div>
...
$(document).ready(function(){
   ...
   $("#parent_category_id").change(function(){
	  ...
	  jQuery.ajax({
                  type:'POST',
                  url:'<?php echo site_url();?>admin/Alternative_medicine/getAjaxSubCategory',
