						...
						<div class="col-md-12">
							<!-- Basic layout-->
								<div class="panel panel-flat">
									...
									<a class="heading-elements-toggle"><i class="icon-menu"></i></a></div>
										<?php 
											echo form_open(site_url().$module_name."/Alternative_medicine/editSubCategory",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
										?>
										<input type='hidden' value="<?php echo $subcategory_data['sub_cat_id']; ?>" name='hidid' />
											...
											<div class="form-group">
													...
													<div class="col-lg-9">
														...
														{
														?>
									<option value="<?php echo $cat['cat_id']; ?>" <?php if($subcategory_data['parent_id']==$cat['cat_id']){ echo "selected"; } ?>><?php echo $cat['category_name']; ?></option>		
                                                        <?php														
														}
														?>
														</select>
