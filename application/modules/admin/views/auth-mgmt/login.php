			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<form action="<?php echo site_url();?>admin/auth/login" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div><img src="<?php echo base_url();?>front_assets/images/logo.png" width="250"></div>
							...
							<div class="text-center">
								<!--<a href="<?php echo ci_site_url();?>admin/auth/forgotPassword/">Forgot password?</a>-->
					...
					<div class="footer text-muted">
						&copy; <?php echo date("Y") ?>.estreyalifestyle. All right reserved
					</div>
					<!-- /footer -->
