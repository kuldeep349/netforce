   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Advertise Management</span> - All Under Approval Advertisement List</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class='active'>All Under Approval Advertisement List</li>
         </ul>
         <ul class="breadcrumb">
         </ul>
      </div>
      ...
      <div class="row">
         <div class="panel panel-flat">
            <div class="panel-heading">
               <h5 class="panel-title">All Under Approval Advertisement List</h5>
            ...
            <table class="table datatable-responsive">
               ...
               <tbody>
                 <?php 
                 if(!empty($all_active_unapproved_adv) && count($all_active_unapproved_adv)>0)
                 {

                     $sno=0;
                     foreach ($all_active_unapproved_adv as $advertisement) 
                     {
                      $sno++;  
