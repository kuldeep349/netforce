   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Payment Mode Management</span> - Add Mobile Money Provider Details</h4>
         </div>
      </div>
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">Add Mobile Money Provider Details</li>
         </ul>
      </div>
   </div>
				<!-- /page header -->
							...
							<!-- Basic layout-->
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Add Mobile Money Provider Details</h5>
									...
									<a class="heading-elements-toggle"><i class="icon-menu"></i></a></div>
										<?php 
										echo form_open(site_url().$module_name."/payment_mode_setting/addMobileMoneyProviderDetails",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
										...
										?>
											<div class="panel-body">
												...
												<div class="form-group">
													...
													<div class="col-lg-9">
														<input type="text" required="" name="mobile_number" class="form-control" placeholder="Enter Corresponding Mobile Number">
													</div>
												</div>
