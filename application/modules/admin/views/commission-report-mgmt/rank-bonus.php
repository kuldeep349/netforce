   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Commission Report</span> - Rank Bonus</h4>
         </div>
   ...
   <div class="content">
      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
            <h5 class="panel-title">Rank Bonus</h5>
         </div>
      </div>
      <!-- /daterange picker -->
      <div class="row">
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="panel bg-primary">
               <div class="panel-heading">
                  <h6 class="panel-title">Total Bonus Amount</h6>
               </div>
               <div class="panel-body">
                  <?php 
                  echo currency()." ";
                  echo (!empty($total_rank_bonus))?$total_rank_bonus:0;
                  ?>
               </div>
            </div>
         </div>
         <div class="col-md-6">
            <div class="panel bg-primary">
               <div class="panel-heading">
                  <h6 class="panel-title">Total Bonus amount transcation</h6>
               </div>
               <div class="panel-body">
                  <?php 
                  echo (!empty($total_no_of_rank_bonus))?$total_no_of_rank_bonus:0;
                  ?>
               </div>
            </div>
         </div>
