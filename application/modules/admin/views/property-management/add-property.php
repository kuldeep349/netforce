   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Property Management</span> - Add New Property</h4>
         </div>
      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="panel panel-flat">
               ...
               <?php 
                  echo form_open(site_url().$module_name."/Property_management/addPropertyList",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
                  									?>
               <div class="panel-body">
                     ...
                     <div class="col-lg-9">
                        <select id="property_type" name='property_type' class='form-control'>
                           <option value="">-Select Property Type-</option>
                              ...
                              {
                              ?>
                                <option value="<?php echo $protype['prop_type_id']; ?>"><?php echo $protype['prop_type_name']; ?></option>
                              <?php														
                              }
                              ?>
                        </select>
                        ...
                        <select name='furnishing_type' id="furnishing_type" class='form-control'>
                          <option value="">-Select Furnishing Type-</option>
                           <?php
                              ...
                              {
                              ?>
                                <option value="<?php echo $furnishtype['furnishing_type_id']; ?>"><?php echo $furnishtype['furnishing_type_name']; ?></option>
                              <?php														
                              }
                              ?>
						</select>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-9">
                        <input type="text" name="price" class="form-control" placeholder="Property Price">
                     </div>
                  </div>
                  <div class="form-group">
...
$(document).ready(function(){
	...
	$("#add_more_image").click(function(){
		$(this).text("Add More Property Sub Images")
		i++;
		var img='<div class="form-group" id="product_'+i+'">';
            img +='<label class="col-lg-3 control-label">Property Sub Image:</label>';
