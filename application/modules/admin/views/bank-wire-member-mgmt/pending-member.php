							...
							<table class="table datatable-responsive">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $member->sponsor_username;?></td>
					                      ...
					                      <ul class="icons-list">
					                        <li class="dropdown">
					                          ...
					                          <ul class="dropdown-menu dropdown-menu-right">
					                            <li><a onclick="return approveConfirm();" href="<?php echo site_url();?>admin/BankWireMemberReport/approveMember/<?php echo ID_encode($member->id);?>">Approve</a>
					                            </li>
					                            
					                            <li><a onclick="return cancelConfirm();" href="<?php echo site_url();?>admin/BankWireMemberReport/cancelMember/<?php echo ID_encode($member->id);?>">Cancel</a>
					                            </li>
					                          </ul>
					                        </li>
					                      </ul>
