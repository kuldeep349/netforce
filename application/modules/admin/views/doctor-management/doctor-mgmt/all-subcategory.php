   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         ...
         <div class="heading-elements">
            ...
            <a href="<?php echo site_url().$module_name;?>/Doctor_Management/addNewDocSubCategory" class="btn btn-success"><i class="icon-comment-discussion position-left"></i> Add New Sub Category</a>
            </div>
                     </div>
         </div>
      </div>
