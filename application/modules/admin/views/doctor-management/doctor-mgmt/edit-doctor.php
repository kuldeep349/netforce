      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="panel panel-flat">
               ...
               <?php 
                  echo form_open(site_url().$module_name."/Doctor_Management/editDoctor",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
                  									?>
               <div class="panel-body">
                <div class="form-group">
                     ...
                     <div class="col-lg-9">
                        <select id="parent_category_id" name='parent_category_id' class='form-control'>
                           <option value="">-Select Category-</option>
                              ...
                              {
                                if($cat['cat_id']==$doctor_data['parent_category_id'])
                                {
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-9">
                      <input type="hidden" name="hidid" value="<?php echo $doctor_data['doctor_id']; ?>">
                        <input type="text" name="doctor_name" class="form-control" placeholder="Doctor Name" value="<?php echo $doctor_data['doctor_name']; ?>">
                     </div>
                  </div>
                  <div class="form-group">
                     <label class="col-lg-3 control-label">Doctor Email <span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                        <input type="email" name="doctor_email" class="form-control" placeholder="Doctor Email" value="<?php echo $doctor_data['doctor_email']; ?>">
                     </div>
                  </div>
                  <div class="form-group">
                     <label class="col-lg-3 control-label">Doctor Phone <span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                        <input type="text" name="doctor_phone" class="form-control" placeholder="Doctor Phone" value="<?php echo $doctor_data['doctor_phone']; ?>">
                     </div>
                  </div>
                   <div class="form-group">
                     <label class="col-lg-3 control-label">Doctor Specialty <span class="required-field">*</span>:</label>
                     <div class="col-lg-9">
                        <input type="text" name="doctor_specialty" class="form-control" placeholder="Doctor Specialty" value="<?php echo $doctor_data['doctor_specialty']; ?>">
                     </div>
                  </div>
                  <div class="form-group">
                    <?php if(!empty($doctor_data['doctor_image'])){ ?>
                    <img width="150" src="<?php echo base_url();?>doctor_images/<?php echo $doctor_data['doctor_image']; ?>">
                    <br/>
                  <?php } ?>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-9">
                        <input type="text"  name="doctor_fee" class="form-control" placeholder="Doctor Fee" value="<?php echo $doctor_data['doctor_fee']; ?>">
                     </div>
                  </div>
                  <?php if(!empty($doctor_time)){
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-9">
                        <div class='input-group date-time' id='datetimepicker1<?php echo $key; ?>'>
                         <input type='text' name="DoctorTime[]" class="form-control" value="<?php echo $value['available_time']; ?>" />
                ...
                <?php } } ?>
                  <div id="add-doctor-time">
                   ...
                   <div class="form-group">
                     ...
                     <div class="col-lg-9">
                        <textarea id="description" name="long_description" class="col-lg-3 control-label"><?php echo $doctor_data['doctor_bio']; ?></textarea>
                     </div>
                  </div>
                  <div class="form-group">
