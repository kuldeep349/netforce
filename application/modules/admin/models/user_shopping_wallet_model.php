...
/*
 * @package admin/User_Shopping_Wallet_Model
*/
class User_Shopping_Wallet_Model extends Common_Model
{
      ...
      public function getAllUserWalletBalance()
      {
      	...
      	->join('shopping_e_wallet as w', 'w.user_id=u.user_id')
      	->get()
      	->result();
      	//pr($result);
      	return $result;
     ...
     public function getAllPendingWalletDepositRequest()
     {
      $res=$this->db->select(array(
        ...
        'ww.amount as ewallet_amount'
         ...
         ->join('shopping_e_wallet as ww', 'ww.user_id=d.user_id')
