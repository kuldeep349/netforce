...
*/
class Eshop_Welcome_Orders extends Common_Controller 
{
	private $moduleName;
	private $user_id;
	private $role;
	...
	{	  	 
		...
		$all_order=$this->db->select('*')->from('eshop_welcome_orders')->where(array('user_id'=>$this->user_id))->order_by('id','desc')->get()->result();
		//pr($all_order);
		$data['all_orders']=$all_order;
		$data['order_type']='all';
		$data['module_name']=$this->moduleName;
		_userLayout("ecommerce/order-welcome-mgmt/all-orders",$data);
	}
	...
	{	  	 
		...
		$data['all_orders']=$all_order;
		$data['module_name']=$this->moduleName;
		_userLayout("ecommerce/order-welcome-mgmt/all-bv",$data);
	}
	...
	public function allPendingOrders()
	{
		...
		$data['module_name']=$this->moduleName;
		$all_order=$this->db->select('*')->from('eshop_welcome_orders')->where(array('order_status'=>'0','user_id'=>$this->user_id))->order_by('id','desc')->get()->result();
		//pr($all_order);
		$data['all_orders']=$all_order;
		$data['module_name']=$this->moduleName;
	...
	public function allConfirmedOrder()
	{
		...
		$data['module_name']=$this->moduleName;
		$all_order=$this->db->select('*')->from('eshop_welcome_orders')->where(array('order_status'=>'1','user_id'=>$this->user_id))->order_by('id','desc')->get()->result();
		//pr($all_order);
		$data['all_orders']=$all_order;
		$data['module_name']=$this->moduleName;
	...
	public function allRejectedOrders()
	{
		...
		$data['module_name']=$this->moduleName;
		$all_order=$this->db->select('*')->from('eshop_welcome_orders')->where(array('order_status'=>'2','user_id'=>$this->user_id))->order_by('id','desc')->get()->result();
		//pr($all_order);
		$data['all_orders']=$all_order;
		$data['module_name']=$this->moduleName;
	...
	public function allDeliveredOrders()
	{
		...
		$data['module_name']=$this->moduleName;
		$all_order=$this->db->select('*')->from('eshop_welcome_orders')->where(array('order_status'=>'3','user_id'=>$this->user_id))->order_by('id','desc')->get()->result();
		//pr($all_order);
		$data['all_orders']=$all_order;
		$data['module_name']=$this->moduleName;
	...
	public function getOrderDetails()
	{
		...
		//$order_id='OR172321';
		$order_info=$this->db->select('*')->from('eshop_welcome_orders')->where('order_id',$order_id)->get()->row();
		//pr($order_info);
