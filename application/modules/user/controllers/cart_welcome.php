...
@package user/user
*/
class Cart_Welcome extends Common_Controller 
{
	...
	{
		if(!empty($this->session->userdata('cart_welcome')))
		{
			$cart=$this->session->userdata('cart_welcome');
		}
		else 
		{
			$cart=array();
		...
		$this->session->set_userdata('cart_welcome',$cart);
		...
		$this->session->set_userdata('cart_welcome_final_price',$cart_total);
		$this->session->set_userdata('cart_welcome_final_bv',$cart_total_bv);
