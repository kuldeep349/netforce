								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											{
											?>
											<a onclick="return uploadProofConfirm();" href="<?php echo site_url();?>user/BankWireMemberReport/uploadProof/<?php echo $member->username;?>">Upload Proof</a>
											<?php 	
											}
											?>
										</td>
...
<script>
  ...
  function uploadProofConfirm()
  {
  	if(window.confirm("Are you sure, you want to upload proof"))
      return true;
    else 
      return false;
  }
