...
<head>
  ...
  <link href="<?php echo base_url();?>admin_assets/assets/css/minified/animate.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.0.0/animate.compat.css"
  />
 <!-- Core JS files -->

 <script type="text/javascript" src="<?php echo base_url();?>admin_assets/assets/js/wow.js"></script>
  ...
  <div class="navbar navbar-inverse">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo site_url();?>">
       <img src="<?php echo base_url();?>front_assets/images/logo.png" alt=""></a>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown dropdown-user">
          ...
          <ul class="dropdown-menu dropdown-menu-right">
            <!-- <li><a href="<?php echo site_url();?>viewProfile"><i class="icon-user-plus"></i> My profile</a></li>
            <li class="divider"></li> -->
            <li><a href="<?php echo site_url();?>join-us"><i class="icon-user-plus"></i> Register Member</a></li>
            <li class="divider"></li>
