                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="p0">
                                                        ...
                                                        <td colspan="2" align="center">
                                                          <div class="media">
                                                            <a href="#" class="has-tooltip profile-thumb">
                                                                ...
                                                                <span class="on-hover">
                                                                    Name : <?php echo $main_first_name . ' ' .$main_last_name;?> <br>
                                                        ...
                                                        <td colspan="4">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tbody>
                                                                    <tr valign="top">
                                                                        <?php
                                                                        if(!empty($level1_user_id1)){
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                              <div class="media">
                                                                                <a href="'.base_url('user/MyGenealogy1/feederStageTree/'.$level1_user_id1).'" class="has-tooltip profile-thumb">';?>
                                                                                    <img class="img-circle" src="<?php echo !empty($level1_1image) ? base_url('images/'.$level1_1image) : base_url('images/noimage.jpeg');?>" alt="' <?php echo $level1_username1;?>'" border="0" width="60">
                                                                                    <?php echo '<span class="on-hover">
                                                                                        Name : '.$level1_first_name1 . ' ' . $level1_last_name1.'<br>
                                                                                        Member ID : '. $level1_user_id1.' <br>
                                                                                        Membership : '.$package[$level1_1member_type] .'<br>
                                                                                        Sponsor : '.$level1_1ref_id.'<br>
                                                                                        Email : '.$level1_1email.' <br>
                                                                                        Country :' .$level1_1country.' <br>
                                                                                    </span>
                                                                                </a>
                                                                                </div>
                                                                                <br>
                                                                                '.$level1_user_id1.'<br>'.$level1_username1.' <br> <br>
                                                                            </td>';
                                                                        }else{
                                                                            echo'<td  id="p1" width="50%" align="center">';
                                                                        ...
                                                                        ?>
                                                                        <?php
                                                                        if(!empty($level1_user_id2)){
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                            <div class="media">
                                                                                <a href="'.base_url('user/MyGenealogy1/feederStageTree/'.$level1_user_id2).'" class="has-tooltip profile-thumb">';?>
                                                                                    <img class="img-circle" src="<?php echo !empty($level1_2image) ? base_url('images/'.$level1_2image) : base_url('images/noimage.jpeg');?>" alt="'<?php echo $level1_username2;?>'" border="0" width="60">
                                                                                <?php echo '<span class="on-hover">
                                                                                        Name : '.$level1_first_name2 . ' ' . $level1_last_name2.'<br>
                                                                                        User ID : '.$level1_user_id2.'<br>
                                                                                        Membership : '.$package[$level1_2member_type] .'<br>
                                                                                        Sponsor : '.$level1_2ref_id.'<br>
                                                                                        Email : '.$level1_2email.' <br>
                                                                                        Country :' .$level1_2country.' <br>
                                                                                    </span>
                                                                                </a>
                                                                                </div>
                                                                                <br>
                                                                                '.$level1_user_id2.'<br>'.$level1_username2.' <br> <br>
                                                                            </td>';
                                                                        }else{
                                                                            echo'<td  id="p1" width="50%" align="center">';
                                                                                echo'<div class="media"><a href="'.base_url('join-us/'.$loginID->username).'">
                                                        ...
                                                        <td colspan="4">
                                                            <table width="100%" height="0%" border="0" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                    <tr align="center">
                                                                        <?php
                                                                        if(!empty($level2_user_id1)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                            <div class="media">
                                                                                <a href="'.base_url('user/MyGenealogy1/feederStageTree/'.$level2_user_id1).'" class="has-tooltip profile-thumb">';?>
                                                                                    <img class="img-circle" src="<?php echo !empty($level2_1image) ? base_url('images/'.$level2_1image) : base_url('images/noimage.jpeg');?>" alt="<?php echo $level2_username1;?>" border="0" width="60">
                                                                                    <?php echo '<span class="on-hover">
                                                                                        Name : '.$level2_first_name1 . ' ' . $level2_last_name1.'<br>
                                                                                        User ID : '. $level2_user_id1.' <br>
                                                                                        Membership : '.$package[$level2_1member_type] .'<br>
                                                                                        Sponsor : '.$level2_1ref_id.'<br>
                                                                                        Email : '.$level2_1email.' <br>
                                                                                        Country :' .$level2_1country.' <br>
                                                                                    </span>
                                                                                    </a>
                                                                                    </div>
                                                                                    <br>
                                                                                    '.$level2_user_id1.'<br>'.$level2_username1.' <br> <br>
                                                                                </td>';
                                                                        }else{
                                                                        ...
                                                                        if(!empty($level2_user_id2)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                            <div class="media">
                                                                                    <a  href="'.base_url('user/MyGenealogy1/feederStageTree/'.$level2_user_id2).'" class="has-tooltip profile-thumb">';?>
                                                                                        <img  class="img-circle" src="<?php echo !empty($level2_2image) ? base_url('images/'.$level2_2image) : base_url('images/noimage.jpeg');?>" alt="<?php echo $level2_username2;?>" border="0" width="60">
                                                                                        <?php echo '<span class="on-hover">
                                                                                            Name : '.$level2_first_name2 . ' ' . $level2_last_name2.'<br>
                                                                                            Member ID : '. $level2_user_id2.' <br>
                                                                                            Membership : '.$package[$level2_2member_type] .'<br>
                                                                                            Sponsor : '.$level2_2ref_id.'<br>
                                                                                            Email : '.$level2_2email.' <br>
                                                                                            Country :' .$level2_2country.' <br>
                                                                                        </span>
                                                                                    </a>
                                                                                    </div>
                                                                                    <br>
                                                                                    '.$level2_user_id2.'<br>'.$level2_username2.' <br> <br>
                                                                                </td>';
                                                                        }else{
                                                                            echo'<td  id="p1" width="25%" height="85%" valign="top">';
                                                                                echo'<div class="media"><a href="'.base_url('join-us/'.$loginID->username).'">
                                                                        ...
                                                                        if(!empty($level2_user_id4)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <div class="media"><a href="'.base_url('user/MyGenealogy1/feederStageTree/'.$level2_user_id4).'" class="has-tooltip profile-thumb">';?>
                                                                                        <img class="img-circle" src="<?php echo !empty($level2_4image) ? base_url('images/'.$level2_4image) : base_url('images/noimage.jpeg');?>" alt="<?php echo $level2_username4;?>" border="0" width="60">
                                                                                        <?php echo '<span class="on-hover">
                                                                                            Name : '.$level2_first_name4 . ' ' . $level2_last_name4.'<br>
                                                                                            Member ID : '. $level2_user_id4.' <br>
                                                                                            Membership : '.$package[$level2_4member_type] .'<br>
                                                                                            Sponsor : '.$level2_4ref_id.'<br>
                                                                                            Email : '.$level2_4email.' <br>
                                                                                            Country :' .$level2_4country.' <br>
                                                                                        </span>
                                                                                    </a></div>
                                                                                    <br>
                                                                                    '.$level2_user_id4.'<br>'.$level2_username4.' <br> <br>
                                                                                </td>';
                                                                        }else{
                                                                            echo'<td  id="p1" width="25%" height="85%" valign="top">';
                                                                                echo'<div class="media"><a href="'.base_url('join-us/'.$loginID->username).'">
                                                                        ...
                                                                        if(!empty($level2_user_id5)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <div class="media"><a href="'.base_url('user/MyGenealogy1/feederStageTree/'.$level2_user_id5).'" class="has-tooltip profile-thumb">';?>
                                                                                        <img class="img-circle" src="<?php echo !empty($level2_5image) ? base_url('images/'.$level2_5image) : base_url('images/noimage.jpeg');?>" alt="<?php echo $level2_username5;?>" border="0" width="60">
                                                                                        <?php echo '<span class="on-hover">
                                                                                            Name : '.$level2_first_name5 . ' ' . $level2_last_name5.'<br>
                                                                                            User Id : '. $level2_user_id5.' <br>
                                                                                            Membership : '.$package[$level2_5member_type] .'<br>
                                                                                            Sponsor : '.$level2_5ref_id.'<br>
                                                                                            Email : '.$level2_5email.' <br>
                                                                                            Country :' .$level2_5country.' <br>
                                                                                        </span>
                                                                                    </a></div>
                                                                                    <br>
                                                                                    '.$level2_user_id5.'<br>'.$level2_username5.' <br> <br>
                                                                                </td>';
                                                                        }else{
                                                                            echo'<td  id="p1" width="25%" height="85%" valign="top">';
                                                                                echo'<div class="media"><a href="'.base_url('join-us/'.$loginID->username).'">
