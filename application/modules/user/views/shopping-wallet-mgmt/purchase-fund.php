   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Shopping Ewallet Management</span> - <?php echo $title;?></h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li>Shopping Ewallet Management</li>
         ...
         <div class="col-md-6">
            ...
            <div class="panel panel-flat border-top-success">
               ...
               <div class="panel panel-flat">
                  ...
                  <?php 
                  echo form_open(site_url()."user/shopping_wallet/purchaseFund",array('method'=>'post','class'=>'panel-body', 'enctype'=>'multipart/form-data'));
                  ?>
                     <div class="panel panel-flat">
                        <div class="panel-heading">
