         ...
         <div class="col-md-6">
            ...
            <div class="panel panel-flat border-top-success">
               ...
               <div class="panel panel-flat">
                  ...
                  echo form_open(site_url()."user/payout/withdrawBalanceS",array('method'=>'post','class'=>'panel-body', 'novalidate' => 'true', 'id' => "form"));
                  ?>
                  ...
                  <!--<form class="panel-body" action="#">-->
                     ...
                     <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                           ...
                           <button type="submit" name="btn1" value="submit"  class="btn btn-info">Transfer to Main Wallet</button>
                        </div>
                     </div>
                  <!--</form>-->
                  </form>
            ...
            <div class="panel panel-body bg-danger-400 has-bg-image">
               <div class="media no-margin">
                  <div class="media-body">
                     ...
                     <span class="text-uppercase text-size-mini">My Saving Wallet Balance</span>
                  </div>
