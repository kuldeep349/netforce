         ...
         <div class="col-md-6">
            ...
            <div class="panel panel-flat border-top-success">
               ...
               <div class="panel panel-flat">
                  ...
                  echo form_open(site_url()."user/payout/withdrawBalanceW",array('method'=>'post','class'=>'panel-body', 'novalidate' => 'true', 'id' => "form"));
                  ?>
            ...
            <div class="panel panel-body bg-danger-400 has-bg-image">
               <div class="media no-margin">
                  <div class="media-body">
                     ...
                     <span class="text-uppercase text-size-mini">My Welcome Wallet Balance</span>
                  </div>
