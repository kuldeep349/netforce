      ...
      <div class="row">
         <div class="panel panel-flat">
            <div class="panel-heading">
               <h5 class="panel-title">Fast Start Income Report</h5>
               ...
               <tbody>
                  ...
                  ?>
                     <tr>
                        ...
                        <td><?php echo $income->tran_description;?></td>
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="panel bg-primary">
               <div class="panel-heading">
                  <h6 class="panel-title">Total Fast Start Income</h6>
               </div>
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel panel-flat border-left-xlg border-left-success">
               <div class="panel-heading">
                  <h6 class="panel-title"><span class="text-semibold">Graph of the Fast Start Commission</span> </h6>
               </div>
               <div class="panel-body">
