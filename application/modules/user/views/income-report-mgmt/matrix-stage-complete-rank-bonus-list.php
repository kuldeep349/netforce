   ...
   <div class="page-header">
      ...
      <div class="page-header-content">
         ...
         <div class="page-title">
            ...
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Wallet Management</span> - Stage Complete Incentive</h4>
      ...
      <div class="breadcrumb-line">
         ...
         <ul class="breadcrumb">
            ...
            <li class="active">Stage Complete Incentive</li>
      ...
      <div class="row">
         ...
         <div class="panel panel-flat">
            ...
            <div class="panel-heading">
               ...
               <h5 class="panel-title">Stage Complete Incentive</h5>
            ...
            <table class="table datatable-responsive">
               ...
               <tbody>
                  ...
                  if(!empty($stage_complete_rank_bonus) && count($stage_complete_rank_bonus)>0)

                  {

                     $sno=1;

                     foreach ($stage_complete_rank_bonus as $income) 

                     {

                      $total_reward_income=$total_reward_income+$income->credit_amt; 
         ...
         <div class="col-md-6">
            ...
            <div class="panel bg-primary">
               ...
               <div class="panel-heading">
                  ...
                  <h6 class="panel-title">Total Direct Referral Income:<?php echo currency()." ".$total_reward_income;?></h6>
