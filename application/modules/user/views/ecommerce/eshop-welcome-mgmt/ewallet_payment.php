      ...
      <div class="row">
		 ...
		 <div class="panel panel-flat">
            <div class="panel-heading">
               <h5 class="panel-title">Ewallet Payment</h5>
               <div class="heading-elements">
                  <ul class="icons-list">
            ...
            <div class="panel-body">
                <form action="<?php echo site_url();?>user/eshop_welcome/ewalletPaymentConfirm/" method="post" enctype="multipart/form-data" class="form-horizontal">
                     <div class="form-group ">
                        <label class="col-sm-3 control-label" for="input-to-email">Enter Transaction Password : </label>
                        <div class="col-sm-6">
                           <input type="password" name="t_password" required value=""  class="form-control" placeholder="Enter Transaction Password">
                        </div>
                     </div>
                     <div class="form-group">
                        <label class="col-sm-3 control-label" for="input-message"><span></span></label>
                        <div class="col-sm-9">
                           <input type="submit" name="ewallet_payment_btn" value="Submit" class="btn btn-primary">
                        </div>
                     </div>
                  </form>
