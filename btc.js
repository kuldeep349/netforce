...
<div class=" row">\
    <div class="col-md-8 col-6 tes">\
		<input class="form-control" id="amount-1" type="text" placeholder="enter amount" style="width:100%;' + crypt_calc_font_style + '">\
	</div>\
	<div class="col-md-4 col-6 tes">\
				<select class="form-control" id="cur-1" style="width:100%;' + crypt_calc_font_style + '">' + outList("BTC") + '</select>\
	</div>\
	<div class="col-md-8 col-6 tes">\
			<input  class="form-control" id="amount-2" type="text" placeholder="enter amount" style="width:100%;' + crypt_calc_font_style + '">\
	</div>\
	<div class="col-md-4 col-6 tes">\
				<select class="form-control" id="cur-2" style="width:100%;' + crypt_calc_font_style + '">' + outList("USD") + '</select>\
	</div>\
</div>\
    \
</div>');
